...
angular.module('core').controller('TeamController', ['$scope',
    function($scope) {
        $scope.team = [
            { name: 'Roy Meirom', title: ['Founder', 'Program Director'], img: 'modules/core/img/team/Roy.jpg', index: 1 },
            { name: 'Adi Goldshtein', title: ['Program Coordinator'], img: 'modules/core/img/team/Adi.jpg', index: 2 },
            { name: 'Aviad Hahami', title: ['Technology Manager'], img: 'modules/core/img/team/Aviad.jpg', index: 3 },
